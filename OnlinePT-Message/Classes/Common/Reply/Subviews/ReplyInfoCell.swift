...
/// cell 示例
class ReplyInfoCell: NiblessTableViewCell {
...
extension ReplyInfoCell : ViewBaseProtocol {
    func setupStyle() {
    ...
    func setupLayout() {
        bgView.snp.makeConstraints{
            $0.left.top.equalTo(ExampleVM.Constant.margin / 2).priority(.low)
            $0.right.bottom.equalTo(-ExampleVM.Constant.margin / 2).priority(.low)
